package com.happy_time.happy_time.ddd.configuration.head_position_config.application;

import com.happy_time.happy_time.ddd.configuration.head_position_config.HeadPositionConfig;
import com.happy_time.happy_time.ddd.configuration.head_position_config.repository.IHeadPositionConfig;
...
public class HeadPositionConfigApplication {
    ...
    public HeadPositionConfig create(HeadPositionConfig config) {
        ...
        headPositionConfig.save(config);
        return config;
    }
}
